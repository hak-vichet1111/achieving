      ...
      <AnimatePresence>
        {open && isPopover && (
          <motion.div
            id="quickadd-panel"
            ref={panelRef}
            className="fixed bottom-28 right-4 sm:right-8 z-[90] w-[22rem] bg-card border rounded-xl p-4 shadow-xl"
          ...
          >
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-lg font-semibold">Quick Add Spending</h3>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  {(['yesterday','today','tomorrow'] as const).map(opt => (
                    ...
                    >
                      {opt === 'today' ? 'Today' : opt === 'yesterday' ? 'Yesterday' : 'Tomorrow'}
                    </button>
                  ))}
                </div>
              </div>
            ...
            <div className="mt-4 flex gap-2">
              <button onClick={() => setOpen(false)} className="flex-1 border border-border rounded-md py-2">Cancel</button>
              <button
                onClick={handleAdd}
      ...
      <AnimatePresence>
        {open && !isPopover && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
          >
            <div className="absolute inset-0 bg-black/40 -z-60" onClick={() => setOpen(false)} />
